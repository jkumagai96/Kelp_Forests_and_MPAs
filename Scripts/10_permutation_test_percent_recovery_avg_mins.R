...
# Purpose: Permutation Analysis - Sensitivity to how percent reocvery is defined (looking at the average of mins)
...
df$min <- apply(mins, 1, FUN = mean, na.rm = T) 
...
write.csv(final_results, 
          "Processed_data/data_tables/bootstrap_percent_recovery_avg_of_mins.csv", 
          row.names = F)
...
png("Figures/Bootstrap_percent_recovery_avg_of_mins.png", width = 5, height = 3, units = "in", res = 600)
plot1
dev.off() 
