...
write.csv(final_results_south, 
          "Processed_data/data_tables/bootstrap_1984_2021_south.csv", 
          row.names = F)
...
write.csv(final_results_central, 
          "Processed_data/data_tables/bootstrap_1984_2021_central.csv", 
          row.names = F)


##### Figures ##################################################################
##### Plot for southern california 
final_results_south <- read.csv("Processed_data/data_tables/bootstrap_1984_2021_south.csv")
...
# Export 
png("Figures/Bootstrap_percent_recovery_median_south.png", width = 5, height = 3, units = "in", res = 600)
plot1
dev.off() 


##### Plot for central california
final_results_central <- read.csv("Processed_data/data_tables/bootstrap_1984_2021_central.csv")
...
# Export
png("Figures/Bootstrap_percent_recovery_median_central.png", width = 5, height = 3, units = "in", res = 600)
plot2
dev.off() 
