...
df$min <- apply(max_2014_2016, 1, FUN = min, na.rm = T) 
df$max <- apply(maxes, 1, FUN = mean, na.rm = T)

df[df$max <= df$min,] # 13 records
...
write.csv(final_results_south, 
          "Processed_data/data_tables/Percent_recovery_max_avg_year_south.csv", 
          row.names = F)
...
write.csv(final_results_central, 
          "Processed_data/data_tables/Percent_recovery_max_avg_year_central.csv", 
          row.names = F)


##### Figures ##################################################################
##### Plot for southern california 
final_results_south <- read.csv("Processed_data/data_tables/Percent_recovery_max_avg_year_south.csv")
...
# Export 
png("Figures/Percent_recovery_max_avg_year_south.png", width = 5, height = 3, units = "in", res = 600)
plot1
dev.off() 


##### Plot for central california
final_results_central <- read.csv("Processed_data/data_tables/Percent_recovery_max_avg_year_central.csv")
...
# Export
png("Figures/Percent_recovery_max_avg_year_central.png", width = 5, height = 3, units = "in", res = 600)
plot2
dev.off() 
